      ...
      sections: [
        {
          ...
          items: [
            ...
            {
              title: '資安防護與滲透修復',
              content: '協同修復壓力測試漏洞，套件版本升級，如：執行 Bootstrap 4 → 5 安全性遷移，並與後端制定 API 加密傳輸規範，落實資安完整性驗證。'
            }
          ]
        },
        {
          ...
          items: [
            {
              title: 'B2B 員工優勢韌力測驗管理平台',
              content: '負責複雜的後台系統開發，實作 RBAC（角色權限控管）機制。整合問卷題型管理、解測日程預約系統，並將原始數據轉化為直觀的統計視覺化圖表，以及針對前台優化網站效能，成功通過<span class="text-accent font-bold">百人同時在線的壓力測試</span>。'
            },
            {
              title: '高彈性 CMS 內容管理架構平台',
              content: '設計多樣化且高彈性的 CMS 組件（標題、影片、圖文、連結等），提供需求端高度自定義的內容製作能力。'
            }
          ]
        },
        {
          title: '品牌官網與會員系統多樣化開發',
          items: [
            {
              title: '多功能品牌會員中心',
              content: '整合第三方登入、會員中心各項功能，運用 Vuex 管理會員資料與狀態，透過 Vue Router 導航守衛，確保跨頁面資料狀態的精準同步與權限控管。'
            },
            {
              title: '互動風格測驗',
            ...
            {
              title: '高視覺動效開發',
              content: '多個品牌網站結合 GSAP + 原生動畫，兼具視覺體驗的流暢，也符合業務與設計需求。',
            },
            {
              title: 'Web Accessibility（無障礙開發）',
              content: '協助切版無障礙頁面，並遵循 WCAG 2.1 規範，優化語義化標籤與鍵盤交互流程，確保公部門專案符合無障礙指標。'
            }
          ]
        }
      ]
