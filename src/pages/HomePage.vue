...
const contactLinks = [
  { label: 'Email', href: PROFILE.email ? `mailto:${PROFILE.email}` : '', icon: emailIcon },
  ...
  <section class="bg-primary">
    <div class="main-container py-20">
      <div class="py-10">
        ...
        <div class="pb-5 text-body lg:max-w-1/2">
          <p>擁有 3 年以上經驗的前端工程師。</p>
          <p>專精於<span class="font-bold text-accent"> Vue 生態系(Pinia、Vuex、Vue Router、Vuetify)</span>，擅長將複雜業務需求轉化為高效、具擴展性的 Web 應用並提升團隊開發效率與使用者體驗。</p>
          <p>目前正積極將開發技術棧延伸至 React 與 TypeScript，追求更嚴謹的型別安全與元件設計模式。</p>
        </div>
        <div class="flex flex-wrap items-center gap-3">
          ...
          >
            <img :src="item.icon" :alt="item.label" width="24" height="24" class="fill-current">
          </a>
        </div>
    </div>
  </section>
